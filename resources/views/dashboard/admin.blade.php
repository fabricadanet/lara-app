                        ...
                        <div class="flex">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Adminstrador</li>
                                </ol>
                            </nav>
                        ...
                        <div class="col">
                            <div class="card-group">
                                <div class="card card-body text-center">
                                    ...
                                    <div class="text-amount">3000 </div>
                                ...
                                <div class="card card-body text-center">
                                    ...
                                    <div class="text-amount">1500</div>
