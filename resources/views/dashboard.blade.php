                                                ...
                                                <div class="chart" style="height: 145px;">
                                                    <canvas id="locationDoughnutChart"
                                                        ...
                                                        <span style="font-size: 1rem;"
                                                            class="text-muted"><strong>Location</strong> doughnut
                                                            chart goes here.</span>
                                                    </canvas>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <a href="#">
                                            <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" width="30%"
                                                style="fill: currentColor;" clip-rule="evenodd" stroke-linejoin="round"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title"><a href="" class="headings-color">UI Design &amp;
                                            Code</a></h5>
                                    <p class="card-text">I want to talk about two things that are quite important
                                        to me. These are love and one my personal inadequacies. The thing is that I’m
