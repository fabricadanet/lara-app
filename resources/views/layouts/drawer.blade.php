            ...
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-menu-item">
                    ...
                    <ul class="sidebar-submenu collapse" id="apps_menu">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="{{route('franchises.create')}}">
                                <span class="sidebar-menu-text">{{__('crud.franchises.create_title')}}</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                ...
                <li class="sidebar-menu-item">
                    ...
                    <ul class="sidebar-submenu collapse" id="layouts_menu">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-product-listing.html">
                                <span class="sidebar-menu-text">Full Width Navs</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fixed-product-listing.html">
                                <span class="sidebar-menu-text">Fixed Navs</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="mini-product-listing.html">
