                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-lg-8 card-form__body card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="width: 270px;" id="npass" type="password" class="form-control ">
                    ...
                    <div class="card card-form">
                        <div class="row no-gutters">
                            <div class="col-lg-4 card-body">
                                ...
                                <p class="text-muted">Atualize o seu perfil público da plataforma. Ele ficará visível
                                    aos demais usuários.</p>
                            </div>
                            <div class="col-lg-8 card-form__body card-body">
                                <div class="form-group">
                                    <label>Foto</label>
                                    <div class="dz-clickable media align-items-center" data-toggle="dropzone"
                                        ...
                                        <div class="mr-3 dz-preview dz-file-preview dz-clickable">
                                            <div class="avatar" style="width: 80px; height: 80px;">
                                                <img src="assets/images/account-add-photo.svg" class="rounded avatar-img"
