            ...
            <div class="mdk-header-layout__content">
                                    ...
                                    <div class="card card-group-row__card">
                                        <div class="card-body d-flex flex-row align-items-center flex-0 border-bottom">
                                            ...
                                            <div class="ml-3 d-flex flex-column align-items-end text-right">
                                                ...
                                                <div class="text-stats text-success">2.6% <i
                                        ...
                                        <div class="card-body flex-0">
                                            <small class="d-flex align-items-center font-weight-bold text-muted mb-1">
                                                ...
                                                <span class="d-flex align-items-center"><i
                                                        class="material-icons text-success icon-16pt mr-1">arrow_upward</i>
                                                    3.2%</span>
                                            </small>
                                            <small class="d-flex align-items-center font-weight-bold text-muted">
                                                ...
                                                <span class="d-flex align-items-center"><i
                                                        class="material-icons text-danger icon-16pt mr-1">arrow_downward</i>
                                                    7.0%</span>
                                            </small>
                                        </div>
                                        <div class="card-body text-muted flex d-flex align-items-center">
                                            <div class="chart w-100" style="height: 200px;">
                                                <canvas id="totalSalesChart">
                                                    <span style="font-size: 1rem;"><strong>Total Sales</strong> chart
                                                        goes
                                                        here.</span>
                                                </canvas>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6 card-group-row__col">
                                    <div class="card card-group-row__card">
                                        <div class="card-body d-flex flex-row align-items-center flex-0 border-bottom">
                                            ...
                                            <div class="ml-3 d-flex flex-column align-items-end text-right">
                                                <a href="" class="mb-2">View</a>
                                                <div class="text-stats text-danger">9.6% <i
                                    ...
                                    <div class="card">
                                        <div class="card-header bg-white d-flex align-items-center">
                                            ...
                                            <div data-toggle="flatpickr" data-flatpickr-wrap="true"
                                                ...
                                                <a href="javascript:void(0)" class="link-date"
                                                    data-toggle>13/03/2018
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body py-4">
                                            ...
                                            <div class="d-flex justify-content-between pb-1">
                                                <span>January</span>
                                                <div>
                                                    <strong>$10,000</strong> <span class="text-muted">/
                                                        $20,000</span>
                                                </div>
                                            </div>
                                            <div class="progress mb-3" style="height: 8px;">
                                                <div class="progress-bar bg-success" role="progressbar"
                                                    style="width: 52%;" aria-valuenow="25" aria-valuemin="0"
                                            ...
                                            <div class="d-flex justify-content-between pb-1">
                                                <span>February</span>
                                                <div>
                                                    <strong>$8,250</strong> <span class="text-muted">/
                                                        $5,230</span>
                                                </div>
                                            </div>
                                            <div class="progress mb-3" style="height: 8px;">
                                            ...
                                            <div class="d-flex justify-content-between pb-1">
                                                <span>March</span>
                                                <div>
                                                    <strong>$1,150</strong> <span class="text-muted">/
                                                        $8,120</span>
                                                </div>
                                            </div>
                                            <div class="progress mb-3" style="height: 8px;">
                                                <div class="progress-bar bg-danger" role="progressbar"
                                                    style="width: 22%;" aria-valuenow="25" aria-valuemin="0"
                                                    aria-valuemax="100"></div>
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-between pb-1">
                                                <span>April</span>
                                                <div>
                                                    <strong>$4,625</strong> <span class="text-muted">/
                                                        $11,450</span>
                                                </div>
                                            </div>
                                            <div class="progress mb-3" style="height: 8px;">
                                            ...
                                            <div class="d-flex justify-content-between pb-1">
                                                <span>May</span>
                                                <div>
                                                    <strong>$5,875</strong> <span class="text-muted">/
                                                        $12,600</span>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6 card-group-row__col">
                                    <div class="card card-group-row__card">
                                        <div class="card-body d-flex flex-row align-items-center flex-0">
                                            ...
                                            <div class="ml-3 d-flex flex-column align-items-end text-right">
                                                <a href="" class="mb-2">View</a>
                                                <div class="text-stats text-success">3.6% <i
                                                        class="material-icons">arrow_upward</i></div>
                                            </div>
                                        </div>
                                        <div class="card-body d-flex flex-column justify-content-center">
                                            <small
                                                class="text-muted text-uppercase mb-3 d-block font-weight-bold">Conversion
                                                Funnel</small>
                                ...
                                <div class="col-lg-4 col-md-12 card-group-row__col">
                                    <div class="card card-group-row__card">
                                        <div class="card-body d-flex flex-row align-items-center flex-0">
                                            ...
                                            <div class="ml-3 d-flex flex-column align-items-end text-right">
                                                <a href="" class="mb-2">View</a>
                                                <div class="text-stats text-success">6.7% <i
                                                        class="material-icons">arrow_upward</i></div>
                                            </div>
                                        </div>
                                        <div class="card-body text-muted flex d-flex align-items-center">
                                                ...
                                                <div class="col-md-8 d-flex justify-content-md-end">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item d-flex align-items-center" href="#">
                                                            <i
                                                                class="material-icons icon-16pt text-success mr-2">check_circle</i>
                                                            <span>Complete</span>
                                                        </a>
                                                        <a class="dropdown-item d-flex align-items-center" href="#">
                                                            <i
                                                                class="material-icons icon-16pt text-danger mr-2">warning</i>
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item list-group-item-action py-2">
                                                <div class="row align-items-center">
                                                    <div class="col-lg-auto">
                                                        <i
                                                            class="material-icons md-18 text-muted align-middle mr-1">check_circle</i>
                                            ...
                                            <li class="list-group-item list-group-item-action py-2">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-lg d-flex align-items-center text-md-right">
                                                        <span
                                                            class="ml-auto badge badge-outline-primary">feature</span>
              ...
              "datasets": [{"label": "Quotes", "data":[53,17,25,5]}]
                                                    ...
                                                    <div class="chart" style="height: 145px;">
                                                        <canvas id="locationDoughnutChart"
                                                            ...
                                                            <span style="font-size: 1rem;"
                                                                class="text-muted"><strong>Location</strong>
                                                                doughnut
                                                                chart goes here.</span>
                                                        </canvas>
                                                    </div>
                            ...
                            <div class="row card-group-row">
                                <div class="col-lg-4 col-md-6 card-group-row__col">
                                    <div class="card card-group-row__card">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-center">
                                            <small class="text-muted text-uppercase mb-2 d-block font-weight-bold">Most
                                                sold items</small>
                                            <small class="d-flex align-items-center font-weight-bold text-muted mb-1">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="card card-social card-facebook">
                                        <div class="card-body">
                                            <a href="#">
                                                <svg viewBox="0 0 16 16" width="30%" style="fill: currentColor;"
                                ...
                                <div class="col-md-3">
                                    <div class="card card-social card-twitter">
                                        <div class="card-body">
                                            <a href="#">
                                                <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" width="30%"
                                                    style="fill: currentColor;" clip-rule="evenodd"
                                                    stroke-linejoin="round" stroke-miterlimit="1.414">
                                                    <path
                                        ...
                                        <div class="col-lg-6 py-2">
                                            <div
                                                ...
                                                <a href=""><img
                                                        ...
                                                        alt="Blog post image"></a>
                                                <div class="flex">
                                                    <h5 class="card-title mb-1"><a href="" class="headings-color">New
                                                            VueJS Launch</a></h5>
                                                    <p class="text-muted mb-2">
                                                        <small class="mr-1"><a href=""
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="card">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <li
                                                class="list-group-item py-2 d-flex align-items-center justify-content-end pr-0">
                                                <div class="mr-auto">Total Visitors</div>
                                                <div>
                                                    <span class="badge badge-outline-primary mr-3">1.3k</span>
                                                </div>
                                                <div
                                                    style="width:100px; height: 50px; margin-top: -10px; position: relative;">
                            ...
                            <div class="card-deck card-margin">
                                <div class="card">
                                    <img src="assets/images/posts/thought-catalog-214785.jpg" class="card-img-top"
                                        alt="">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title"><a href="" class="headings-color">UI Design &amp;
                                                Code</a></h5>
                                        <p class="card-text">I want to talk about two things that are quite
                                            important
                                            to me. These are love and one my personal inadequacies. The thing is that
                                            I’m
                                            quite fond of love...</p>
                                    </div>
                                    <div class="card-footer d-flex justify-content-between">
                                        <a href="#" class="text-social text-facebook">
                                            <svg viewBox="0 0 16 16" width="20%" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="card dashboard-chat">
                                    ...
                                    <div class="d-flex dashboard-chat__head">
                                        ...
                                        <div class="dropdown">
                                            <a class="dropdown-toggle btn btn-white btn-sm text-muted" href="#"
                                                id="chatSettings" data-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false" data-caret="false">
                                                <i class="material-icons icon-16pt">settings</i>
                                            </a>

                                            <div class="dropdown-menu dropdown-menu-right"
                                                aria-labelledby="chatSettings">
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <i class="material-icons icon-16pt mr-2">settings</i>
                                                    <span>Settings</span>
                                                </a>
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="media align-items-center mb-3">
                                            ...
                                            <div class="media-body">
                                                <div class="dashboard-chat__message dashboard-chat__message-in">
                                                    Awesome! Just got back from my 2 weeks vacation and I had such a
                                                    great
                                                    time.
                                                </div>
                                            </div>
                                        ...
                                        <div class="input-group input-group-merge mt-auto">
                                            <input type="text" class="form-control form-control-prepended"
                                                name="chat-message" placeholder="Type a message...">
                                                ...
                                                <ul class="sidebar-submenu collapse" id="login_menu">
                                                    <li class="sidebar-menu-item">
                                                        <a class="sidebar-menu-button" href="login.html">
                                                            <span class="sidebar-menu-text">Login / Background
                                                                Image</span>
                                                        </a>
                                                    </li>
                                                    <li class="sidebar-menu-item">
                                                        <a class="sidebar-menu-button"
                                                            ...
                                                            <span class="sidebar-menu-text">Login / Centered
                                                                Boxed</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                                ...
                                                <ul class="sidebar-submenu collapse" id="signup_menu">
                                                    ...
                                                    <li class="sidebar-menu-item">
                                                        <a class="sidebar-menu-button"
                                                            ...
                                                            <span class="sidebar-menu-text">Sign Up / Centered
                                                                Boxed</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                ...
                                <div class="sidebar-block p-0 mb-0">
                                    <ul class="sidebar-menu" id="components_menu">
                                        ...
                                        <li class="sidebar-menu-item">
                                            <a class="sidebar-menu-button" href="ui-tables.html">
                                                <i
                                                    class="sidebar-menu-icon sidebar-menu-icon--left material-icons">dns</i>
                                        ...
                                        <li class="sidebar-menu-item">
                                            <a class="sidebar-menu-button" href="ui-tabs.html">
                                                <i
                                                    class="sidebar-menu-icon sidebar-menu-icon--left material-icons">tab</i>
                                    ...
                                    <div class="sidebar-p-a sidebar-b-y">
                                        <div class="d-flex align-items-top mb-2">
                                            <div class="sidebar-heading m-0 p-0 flex text-body js-text-body">Progress
                                            </div>
